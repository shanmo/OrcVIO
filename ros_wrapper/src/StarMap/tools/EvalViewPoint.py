...
print('|        |', end='')
for k in sorted(acc10):
  print('{:8s}|'.format(k), end='')
print(' Mean |')
for k in range(len(sorted(acc10)) + 2):
  print('|--------', end='')
print('|')
print('| Acc10  |', end='')
for k in sorted(acc10):
  print('{:.4f}'.format(acc10[k]), ' |', end='')
print('{:.4f} |'.format(accAll10 / numAll))
print('| Acc30  |', end='')
for k in sorted(acc10):
  print('{:.4f}'.format(acc30[k]), ' |', end='')
print('{:.4f} |'.format(accAll30 / numAll))
print('| Mid    |', end='')
for k in sorted(mid):
  print('{:7.2f}'.format(mid[k]), '|', end='')
print('{:7.2f}|'.format(np.sort(np.array(err_all))[len(err_all) // 2]))

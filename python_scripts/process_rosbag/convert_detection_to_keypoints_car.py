...
if __name__ == "__main__":
    ...
    # one example is 
    # python convert_detection_to_keypoints.py --input_bag /media/erl/disk1/orcvio/opcity_smooth/docker_compose_opcity_20cars_quad_no_occ_with_doors.bag --output_bag /media/erl/disk1/orcvio/opcity_smooth/docker_compose_opcity_car_door_quad.bag 

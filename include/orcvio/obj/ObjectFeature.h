...
namespace orcvio 
{
    ...
    public:
        ...
        // map object class to number of keypoints 
        std::unordered_map<std::string, int> umap_class_to_kps;
         ...
         object_id(_object_id), object_class(_object_class)
        {
            ...
            create_class_to_kps_map();
            auto class_name_iter = umap_class_to_kps.find(object_class);
            if (class_name_iter != umap_class_to_kps.end())
            {
                sem_kp_num = umap_class_to_kps[object_class]; 
            } 
            else 
            {
                // unknown class 
        ...
        /**
         * @brief create a mapping from object class to number of keypoints 
         */
        void create_class_to_kps_map();
